...
static String_And_Flag default_keywords[] = {
    ...
    {make_stafl("procedure" , CPP_TOKEN_KEY_TYPE_DECLARATION)},
    {make_stafl("global_variable" , CPP_TOKEN_KEY_TYPE_DECLARATION)},
    {make_stafl("local_persist" , CPP_TOKEN_KEY_TYPE_DECLARATION)},
    {make_stafl("function" , CPP_TOKEN_KEY_TYPE_DECLARATION)},
    {make_stafl("let" , CPP_TOKEN_KEY_TYPE_DECLARATION)},
